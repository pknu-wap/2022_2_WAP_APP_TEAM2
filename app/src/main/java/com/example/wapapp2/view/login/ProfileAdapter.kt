...
class ProfileAdapter(val profileList: ArrayList<Profiles>, private val onClickListener: ListOnClickListener<Profiles>) : RecyclerView
.Adapter<ProfileAdapter.CustomViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CustomViewHolder {
        ...
        return CustomViewHolder(view).apply {
            itemView.setOnClickListener {
                ...
                onClickListener.onClicked(profileList[adapterPosition], adapterPosition)
            }
        }
    }
